...
arena = Arena()
arena.add_obj('A', 93, 111-35)
arena.add_obj('B', 26, 157)
arena.add_obj('C', 250-4, 28)
arena.add_obj('D', 120, 111)
arena.add_obj('E', 28, 69)
arena.add_obj('F', 5, 8)
arena.add_obj('G', 8, 240)
arena.add_obj('H', 162, 38)
arena.add_obj('I', 250-43, 250-35)
arena.add_obj('J', 250-93, 250-100)
arena.find_route()
arena.show()
#928 expected
